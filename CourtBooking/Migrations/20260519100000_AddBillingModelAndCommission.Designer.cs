...
namespace CourtBooking.Migrations
{
    ...
    [Migration("20260519100000_AddBillingModelAndCommission")]
    partial class AddBillingModelAndCommission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtBooking.Models.Sport", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Description = "Racket sport played on a rectangular court.", DisplayOrder = 1, IsActive = true, Name = "Tennis" },
                        new { Id = 2, Description = "Fast-paced racket sport using a shuttlecock.", DisplayOrder = 2, IsActive = true, Name = "Badminton" },
                        new { Id = 3, Description = "Team sport played on a rectangular court.", DisplayOrder = 3, IsActive = true, Name = "Basketball" },
                        new { Id = 4, Description = "Team sport played over a net.", DisplayOrder = 4, IsActive = true, Name = "Volleyball" },
                        new { Id = 5, Description = "Team sport played on a grass or turf field.", DisplayOrder = 5, IsActive = true, Name = "Football" },
                        new { Id = 6, Description = "Indoor variant of football on a smaller court.", DisplayOrder = 6, IsActive = true, Name = "Futsal" },
                        new { Id = 7, Description = "Fast-growing paddle sport combining tennis, badminton, and ping-pong.", DisplayOrder = 7, IsActive = true, Name = "Pickleball" });
                });
            ...
            modelBuilder.Entity("CourtBooking.Models.Booking", b =>
                {
                    b.HasOne("CourtBooking.Models.Court", "Court")
                        .WithMany("Bookings").HasForeignKey("CourtId")
            ...
            modelBuilder.Entity("CourtBooking.Models.Court", b =>
                {
                    b.HasOne("CourtBooking.Models.ApplicationUser", "Owner")
                        .WithMany().HasForeignKey("OwnerId").OnDelete(DeleteBehavior.SetNull);
                    b.Navigation("Owner");
                });
            ...
            modelBuilder.Entity("CourtBooking.Models.CourtTimeSlot", b =>
                {
                    b.HasOne("CourtBooking.Models.Court", "Court")
                        .WithMany("TimeSlots").HasForeignKey("CourtId")
                        .OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Court");
                });
            ...
            modelBuilder.Entity("CourtBooking.Models.Review", b =>
                {
                    b.HasOne("CourtBooking.Models.ApplicationUser", "Owner")
                        .WithMany().HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Owner");
                });
